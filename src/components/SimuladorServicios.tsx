...
{ id: "design-posts", nome: "Post design", categoria: "Design", cor: "#F25C05", descricao: "Professional visual design for your social feeds.", detalhamento: ["Custom graphic posts", "Informative carousels", "Stories and Reels", "Banners and covers", "Brand templates"] },
  { id: "logotipo", nome: "Logo design", categoria: "Design", cor: "#F25C05", descricao: "Distinctive, professional logo concepts.", detalhamento: ["3 initial concepts", "Unlimited revisions", "Multiple file formats", "Basic brand guidelines", "Commercial use"] },
  { id: "identidade", nome: "Corporate identity", categoria: "Design", cor: "#F25C05", descricao: "Complete visual identity for your brand.", detalhamento: ["Logo + variations", "Colour palette", "Typography", "Business card", "Corporate folder"] },
