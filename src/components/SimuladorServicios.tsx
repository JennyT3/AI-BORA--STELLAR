...
const ICONS: Record<string, string> = {
  ...
  "Google Ads": `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>`,
...
const SERVICOS = [
  ...
  { id: "seo", nome: "SEO Local", categoria: "Web", cor: "#3498DB", descricao: "Otimização para Google Local.", detalhamento: ["Google Business otimizado", "Palavras-chave locais", "Backlinks locais", "Gestão de avaliações", "Relatórios mensais"] },
  { id: "google-ads", nome: "Google Ads", categoria: "Publicidade", cor: "#F39C12", descricao: "Campanhas de Google Ads.", detalhamento: ["Pesquisa de Keywords", "Criação de campanhas", "Otimização de bids", "Extensões de anúncios", "Relatórios de ROAS"] },
