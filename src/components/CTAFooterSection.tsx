          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 relative z-10">
            ...
            <div className="bg-surface2 border border-black/5 rounded-3xl p-8">
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  <label htmlFor="negocio" className="block text-sm font-bold text-text-primary mb-2">Nome do Negócio <span className="text-fuchsia-brand">*</span></label>
                  <input 
                    type="text" 
                    id="negocio" 
                    required
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="tel" className="block text-sm font-bold text-text-primary mb-2">Telemóvel <span className="text-fuchsia-brand">*</span></label>
                    <input 
                      type="tel" 
                      id="tel" 
                      required
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full bg-grad text-white font-bold text-lg h-14 rounded-full flex items-center justify-center gap-2 mt-4 shadow-md"
                >
                  Enviar mensagem →
                </motion.button>
              </form>
