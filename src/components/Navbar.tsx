  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        ...
        >
          <Link href="/servicos" onClick={() => setIsMobileMenuOpen(false)} className="text-xl font-bold text-text-primary hover:text-[#F22283]">Services</Link>
          <button onClick={() => scrollToSection('quem-somos')} className="text-xl font-bold text-text-primary hover:text-[#F22283]">About us</button>
          <button onClick={() => scrollToSection('processo')} className="text-xl font-bold text-text-primary hover:text-[#F22283]">How it works</button>
