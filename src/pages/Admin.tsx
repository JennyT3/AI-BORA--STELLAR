        ...
        <div style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
          <div style={{ backgroundColor: "#fff", borderRadius: 16, padding: 24, maxWidth: 400, width: "90%", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <button onClick={() => { gerarFaturaPDF(faturaData, numeroFatura); setShowFaturaModal(false); }} style={{ flex: 1, padding: "12px", borderRadius: 8, backgroundColor: "theme.colors.accent.primary", color: "#fff", border: "none", fontWeight: 600, cursor: "pointer" }}>Gerar PDF</button>
