  ...
  return (
    <div style={{ minHeight: '100vh', background: colors.light, fontFamily: 'Montserrat, sans-serif' }}>
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '40px 32px' }}>
          ...
          <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: 12, marginBottom: 8, flexWrap: 'wrap' }}>
                ...
                <span style={{ background: '#f5f5f5', color: '#666', padding: '4px 12px', borderRadius: 20, fontSize: 11, fontWeight: 600 }}>{trilha.aulas.length} aulas</span>
              </div>
        ...
        {/* Lista de aulas */}
        <h2 style={{ fontSize: 20, fontWeight: 700, color: colors.dark, marginBottom: 20 }}>Conteúdo da Trilha</h2>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                    ...
                    {aulaConcluida && (
                      <span style={{ background: '#10B98120', color: '#10B981', padding: '2px 8px', borderRadius: 10, fontSize: 10, fontWeight: 600 }}>Concluída</span>
                    )}
                  </div>
