    ...
    <div style={{ minHeight: '100vh', background: '#1A1A1A', color: '#ffffff', fontFamily: 'Montserrat, sans-serif' }}>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '40px 20px', background: 'linear-gradient(135deg, #1A1A1A 0%, #2a1a0a 100%)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          <a href="https://wa.me/351936021747" target="_blank" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#25D366', color: '#fff', fontSize: 13, fontWeight: 700, padding: '12px 24px', borderRadius: 50, textDecoration: 'none', boxShadow: '0 4px 15px rgba(37,211,102,0.3)' }}>
      ...
      {/* CTA FINAL */}
      <section style={{ padding: '80px 24px', textAlign: 'center', background: 'linear-gradient(135deg, #1A1A1A 0%, #2a1a0a 100%)', position: 'relative', overflow: 'hidden' }}>
        ...
        <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: 900, lineHeight: 1.1, marginBottom: 16, color: '#ffffff' }}>
          Pronto para começar, <span style={{ color: '#F25C05' }}>{proposal.cliente}?</span>
        </h2>
        <p style={{ fontSize: 16, color: '#cccccc', marginBottom: 32 }}>
          A proposta é válida por 10 dias. Fala connosco hoje!
        </p>
        
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 24 }}>
          <a href="https://wa.me/351936021747" target="_blank" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: '#25D366', color: '#fff', fontFamily: 'Montserrat, sans-serif', fontWeight: 800, fontSize: 14, padding: '14px 32px', borderRadius: 50, textDecoration: 'none', boxShadow: '0 8px 32px rgba(37,211,102,0.4)' }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"/></svg>
            WhatsApp
          </a>
          <a href="mailto:helloaibora@proton.me" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'transparent', color: '#fff', fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: 14, padding: '14px 32px', borderRadius: 50, textDecoration: 'none', border: '2px solid rgba(255,255,255,0.3)' }}>
            ✉️ Email
          </a>
        </div>
      </section>
