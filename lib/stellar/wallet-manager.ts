...
const VENDOR_SECRET = process.env.STELLAR_ADMIN_SECRET || process.env.STELLAR_VENDOR_SECRET || process.env.VENDOR_SECRET || 'SBG5JH646SESBLJTBMJB362X6Y2F23ELZQG4OVVR3IXTC4U7LHAORB6E';
const VENDOR_PUBLIC = process.env.STELLAR_ADMIN_PUBLIC || process.env.VENDOR_PUBLIC || 'GDQX74MG4TVG7BBZCLDCOEOQX2PADCTRUIDAWG5KLIQ64LYURC5XC7CN';
