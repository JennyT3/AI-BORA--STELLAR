...
export interface ClientFormModalProps {
  ...
  onSuggestionSelect: (client: any) => void;
...
export function ClientFormModal(props: ClientFormModalProps) {
  ...
  const isEditing = !!clientFormData?.id || !!clientFormData.createdAt;

  useEffect(() => {
    listActiveSalesReps().then(setSalesRepsList).catch(console.error);
  }, []);

  const hasDocumentos = clientFormData?.requestId || clientFormData?.quoteIds?.length > 0 || clientFormData?.proposalIds?.length > 0 || clientFormData?.invoiceIds?.length > 0;
        ...
        <div style={{ display: "grid", gap: 20 }}>
          ...
          <div style={sectionStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 12 }}>
              <div style={{ position: "relative" }}>
                ...
                <input type="text" value={clientFormData.name} onChange={(e) => { onFieldChange("name", e.target.value); onClientSearchChange(e.target.value); }} style={inputStyle} placeholder="Client name" />
                {showClientSuggestions && clientSearch.length > 0 && (
                  <div style={{ position: "absolute", top: "100%", left: 0, right: 0, backgroundColor: "#fff", border: "1px solid #f0edeb", borderRadius: 10, boxShadow: "0 10px 25px rgba(0,0,0,0.1)", zIndex: 100, maxHeight: 150, overflow: "auto", marginTop: 4 }}>
                    {clients.filter(c => c.name?.toLowerCase().includes(clientSearch.toLowerCase())).slice(0, 5).map(c => (
                      <div key={c.id} onClick={() => onSuggestionSelect(c)} style={{ padding: "10px 14px", cursor: "pointer", borderBottom: "1px solid #fcf9f7", fontSize: 12 }}>{c.name} <span style={{ color: "#8e7165" }}>| {c.email}</span></div>
                    ))}
                  </div>
                )}
              </div>
              <div>
                ...
                <select value={clientFormData.source || ""} onChange={(e) => onFieldChange("source", e.target.value)} style={selectStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 12 }}>
              <div>
                ...
                <input type="email" value={clientFormData.email || ""} onChange={(e) => onFieldChange("email", e.target.value)} style={inputStyle} placeholder="you@example.com" />
              </div>
              <div>
                <label style={labelStyle}>Mobile</label>
                <input type="tel" value={clientFormData.mobile || ""} onChange={(e) => onFieldChange("phone", e.target.value)} style={inputStyle} placeholder="+351..." />
              </div>
            </div>
            <div style={{ marginTop: 12 }}>
              <label style={labelStyle}>TAXID</label>
              <input type="text" value={clientFormData.taxId || ""} onChange={(e) => onFieldChange("taxId", e.target.value)} style={{ ...inputStyle, maxWidth: 200 }} placeholder="123456789" />
            </div>
          </div>
          ...
          <div style={sectionStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <input type="text" value={clientFormData.company || ""} onChange={(e) => onFieldChange("company", e.target.value)} style={inputStyle} placeholder="Company name" />
              </div>
              <div>
                <label style={labelStyle}>Website</label>
                <input type="text" value={clientFormData.website || ""} onChange={(e) => onFieldChange("website", e.target.value)} style={inputStyle} placeholder="https://..." />
              </div>
            </div>
          </div>
          ...
          <div style={sectionStyle}>
            ...
            <div>
              ...
              <input type="text" value={clientFormData.address || ""} onChange={(e) => onFieldChange("address", e.target.value)} style={inputStyle} placeholder="Street, number, floor..." />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 12 }}>
              <div>
                <label style={labelStyle}>Postal code</label>
                <input type="text" value={clientFormData.postalCode || ""} onChange={(e) => onFieldChange("postalCode", e.target.value)} style={inputStyle} placeholder="0000-000" />
              </div>
              <div>
                <label style={labelStyle}>City</label>
                <input type="text" value={clientFormData.city || ""} onChange={(e) => onFieldChange("city", e.target.value)} style={inputStyle} placeholder="Lisbon, Porto..." />
              </div>
            </div>
          </div>
          ...
          <div style={sectionStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <select value={clientFormData.category || "curious"} onChange={(e) => onFieldChange("category", e.target.value)} style={selectStyle}>
                  <option value="curious">Browsing</option>
              ...
              <div>
                ...
                <select value={clientFormData.stage || "no_stage"} onChange={(e) => onFieldChange("stage", e.target.value)} style={selectStyle}>
                  <option value="no_stage">No process</option>
            ...
            <div style={{ marginTop: 12 }}>
              ...
              <input type="date" value={clientFormData.lastContactDate ? clientFormData.lastContactDate.split("T")[0] : ""} onChange={(e) => onFieldChange("lastContactDate", e.target.value ? e.target.value + "T00:00:00.000Z" : "")} style={inputStyle} />
            </div>
          </div>
          ...
          <div style={sectionStyle}>
            ...
            <div>
              ...
              <textarea value={clientFormData.salesRepNotes || ""} onChange={(e) => onFieldChange("salesRepNotes", e.target.value)} rows={2} style={{ ...inputStyle, fontFamily: "inherit", resize: "vertical" }} placeholder="Internal notes..." />
            </div>
            <div style={{ marginTop: 12 }}>
              <label style={labelStyle}>Client-visible notes</label>
              <textarea value={clientFormData.notes || ""} onChange={(e) => onFieldChange("notes", e.target.value)} rows={2} style={{ ...inputStyle, fontFamily: "inherit", resize: "vertical" }} placeholder="Notes visible to the client..." />
            </div>
          </div>
          ...
          <div style={sectionStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <select value={clientFormData.salesRepId || ""} onChange={(e) => onFieldChange("salesRepId", e.target.value)} style={selectStyle}>
              ...
              <div>
                ...
                <input type="text" value={clientFormData.createdBy || ""} onChange={(e) => onFieldChange("createdBy", e.target.value)} style={inputStyle} placeholder="admin, import..." />
              </div>
            </div>
          </div>
          ...
          {hasDocumentos && (
            <div style={{ backgroundColor: "#fcf9f7", borderRadius: 16, padding: 20 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {clientFormData.requestId && (
                  <span style={{ padding: "6px 12px", backgroundColor: "#fff", borderRadius: 8, fontSize: 11, fontWeight: 700, color: "#5a4137" }}>Request: {clientFormData.requestId}</span>
                )}
                {clientFormData.quoteIds?.map((id: string, i: number) => (
                ...
                {clientFormData.proposalIds?.map((id: string, i: number) => (
                ...
                {clientFormData.invoiceIds?.map((id: string, i: number) => (
